...
{
    public class ThresholdProgressBar : Control
    {
        ...
        {
            get { return _thresholdStart; }
            set { _thresholdStart = value; }
        }

        private int _thresholdOptimal;
        public int ThresholdOptimal
        {
            get { return _thresholdOptimal; }
            set { _thresholdOptimal = value; }
        }
